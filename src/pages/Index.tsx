          ...
          <TabsList className="grid w-full grid-cols-6 mb-6 glass glass-dark shadow-modern-md">
            ...
            <div className="flex gap-1">
              <TabsTrigger 
                value="monitor" 
                className="flex items-center gap-2 transition-all duration-300 hover:shadow-glow data-[state=active]:bg-gradient-primary data-[state=active]:text-primary-foreground" 
                style={{transform: 'scale(0.6)', transformOrigin: 'left center', width: '60%'}}
              >
                <Monitor className="h-4 w-4" />
                Monitor de Dados
              </TabsTrigger>
              <button 
                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-sm transition-all duration-300 hover:shadow-glow bg-gradient-primary text-primary-foreground" 
                style={{width: '40%'}}
              >
                Salvar
              </button>
          ...
          <TabsContent value="monitor">
            <div className="space-y-6">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold mb-2">Monitor de Dados do Sistema</h2>
                <p className="text-muted-foreground">Visualize e gerencie os dados armazenados no sistema</p>
              </div>
              
              <ScheduleStatus />
              <DebugPanel employees={employees} />
              <DataRecovery />
            </div>
          </TabsContent>
        </Tabs>
